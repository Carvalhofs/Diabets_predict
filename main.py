...
st.write("""#### Aplicação busca proporcionar autodiagnóstico preliminar do usuário visando a busca imediata de um médico para diagnóstico precoce de Diabetes.""")
